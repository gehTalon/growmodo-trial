  ...
  <div class="container">
    ...
    <div class="section-content">
      <div class="carousel-copy-swiper">
        <?php if ($faqs = get_field('select_faq')) : ?>
          <div class="swiper-wrapper">
            <?php foreach ($faqs as $item) :
              $faq_id = $item['faq'] ?? null;
              if (!$faq_id) continue; 

              $link_url = get_permalink($faq_id);
              $title    = get_the_title($faq_id);             
              $top_title = $item['top_title'] ?? ''; 
              $faq_details = get_field('description', $faq_id);             
              $details = get_field('details', $faq_id);
                ...
                <div class="content">
                  ...
                  <div class="testimonial-holder">                    
                    ...
                    <div class="testimonial-bottom-info">
                      <a href="<?= esc_url($link_url); ?>" class="cta-button transparent">Read More</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <?php endif; ?>
        <div class="faq-bottom-content d-flex justify-content-between">
          <div class="faq-pagination d-flex">
            <div class="faq-pagination-bullets"><span class="current-bullet">01</span> of 10</div>          
          </div>
